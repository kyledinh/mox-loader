...
* The `Color BG Red` button demonstrates the feature of injecting Javascript code back to the active tab. In simple feature will change that background color to red.   
